...
# INLINED from types.mojo - imports don't work in shared library context
# See docs/context/01-11-2026-mojo-ffi-constraints.md

# Normalization constants (match mojo_audio.h enum)
comptime MOJO_NORM_NONE: Int32 = 0
comptime MOJO_NORM_WHISPER: Int32 = 1
comptime MOJO_NORM_MINMAX: Int32 = 2
comptime MOJO_NORM_ZSCORE: Int32 = 3

# Error codes (match C enum)
...
struct MojoMelConfig(Copyable, Movable):
    ...
    fn __init__(out self):
        ...
        self.hop_length = 160
        self.n_mels = 80
        self.normalization = MOJO_NORM_NONE
